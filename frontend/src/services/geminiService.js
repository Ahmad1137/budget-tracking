...
try {
  ...
  console.warn(
    "Google Generative AI not installed. AI features will use fallback descriptions."
  );
}
...
export const generateTransactionDescription = async (
  type,
  category,
  amount
) => {
  try {
    ...
    const fallbackDescriptions = {
      Food: `${
        type === "expense" ? "Meal purchase" : "Food income"
      } $${amount}`,
      Transportation: `${
        type === "expense" ? "Transport expense" : "Transport income"
      } $${amount}`,
      Entertainment: `${
        type === "expense" ? "Entertainment purchase" : "Entertainment income"
      } $${amount}`,
      Shopping: `${
        type === "expense" ? "Shopping expense" : "Shopping income"
      } $${amount}`,
      Bills: `${
        type === "expense" ? "Bill payment" : "Bill refund"
      } $${amount}`,
      Healthcare: `${
        type === "expense" ? "Healthcare expense" : "Healthcare income"
      } $${amount}`,
